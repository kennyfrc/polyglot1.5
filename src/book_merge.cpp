...
// entry->sum   = (uint16)read_integer(book->file,2);
   entry->score = (uint16)read_integer(book->file,2);
   entry->depth = (uint8)read_integer(book->file,1);
   entry->learn = (uint8)read_integer(book->file,1);
...
// write_integer(book->file,2,entry->sum);
   write_integer(book->file,2,entry->score);
   write_integer(book->file,1,entry->depth);
   write_integer(book->file,1,entry->learn);
}
